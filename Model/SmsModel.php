...
namespace MauticPlugin\MauticInfoBipSmsBundle\Model;
...
class SmsModel extends FormModel implements AjaxLookupModelInterface
{
     ...
     * {@inheritdoc}
     *
     * @return \MauticPlugin\InfoBipSmsBundle\Entity\SmsRepository
     */
    public function getRepository()
    {
        return $this->em->getRepository('MauticInfoBipSmsBundle:Sms');
    }

    /**
     * @return \MauticPlugin\InfoBipSmsBundle\Entity\StatRepository
     */
    public function getStatRepository()
    {
        return $this->em->getRepository('MauticInfoBipSmsBundle:Stat');
    }
